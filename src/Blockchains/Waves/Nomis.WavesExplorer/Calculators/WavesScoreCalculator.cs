// ------------------------------------------------------------------------------------------------------
// <copyright file="WavesScoreCalculator.cs" company="Nomis">
...
{
    /// <summary>
    /// Waves wallet score calculator.
    /// </summary>
    internal static class WavesScoreCalculator
    {
        ...
        public static double GetScore(this IWalletStats<WavesTransactionIntervalData> stats)
        {
            if (stats.NoData)
            {
                return 0;
